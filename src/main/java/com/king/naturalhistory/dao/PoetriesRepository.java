...
import com.king.naturalhistory.bean.PoetriesEntity;
...
@Repository
public interface PoetriesRepository extends JpaRepository<PoetriesEntity, Integer> {
    List<PoetriesEntity> findByTitle(String title);
